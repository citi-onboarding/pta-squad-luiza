...
const MedicalAgenda = () => {
	const [filter, setFilter] = useState<"morning" | "afternoon" | "night" | null>(
		null
	);
	...
	return (
		<View className="flex-1 bg-gray-100">
			<View className="flex-1 bg-white w-full px-2 pt-12">
				{/* Logomarca */}
				...
				{/* Filtros por período */}
				<View className="mx-auto flex-row justify-around items-center bg-white w-full max-w-[350px] h-[70px] mb-6 rounded-full shadow px-4">
					<TouchableOpacity onPress={() => setFilter("morning")}>
						<Image
							...
							style={{
								...
								resizeMode: "contain",
								tintColor:
									filter === "morning" ? "#50E678" : undefined,
							}}
						/>
					</TouchableOpacity>
					<TouchableOpacity onPress={() => setFilter("afternoon")}>
						<Image
							...
							style={{
								...
								resizeMode: "contain",
								tintColor:
									filter === "afternoon" ? "#50E678" : undefined,
							}}
						/>
					</TouchableOpacity>
